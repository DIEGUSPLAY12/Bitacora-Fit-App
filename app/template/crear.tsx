  ...
  return (
    ...
    >
      <View style={[styles.header, { paddingTop: insets.top + 16 }]}>
        ...
        <Text style={styles.headerTitle} numberOfLines={1}>Crear Plantilla</Text>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.nameContainer}>
          ...
          <TextInput
            ...
            placeholder="Ej. Tracción, Pierna pesada..."
        ...
        {exercises.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>Añade ejercicios para construir tu plantilla.</Text>
          </View>
        ) : (
        ...
        <TouchableOpacity 
          ...
          onPress={() => router.push({ pathname: '/ejercicios', params: { isTemplate: 'true' } })}
          activeOpacity={0.8}
        >
